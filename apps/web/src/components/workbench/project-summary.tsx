  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          <label className="text-sm font-medium mb-2 block">Project Overview</label>
          <RichTextEditor
            content={sowData.projectOverview || ''}
            onChange={(content) => handleFieldUpdate('projectOverview', content)}
            placeholder="Describe the project in detail - what are you building, why, and what problem does it solve? Use rich formatting to make your overview stand out."
